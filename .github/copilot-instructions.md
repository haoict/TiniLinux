...
**Build Workflow**
- **Prerequisites:** Build environment requires `build-essential cmake mtools libncurses-dev dosfstools parted`. The buildroot repo (2026.02 branch) is auto-cloned by [make-board-build.sh](../scripts/make-board-build.sh) if not present as a sibling `../buildroot/`.
